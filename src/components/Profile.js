...
import { Grid, Header, Card, Image, Statistic, Item, Loader, Button, Icon, Divider } from 'semantic-ui-react';
      ...
      return (
        <div className={styles.notLoggedIn}>
          <div>
            ...
            <Button className={styles.login} onClick={() => this.props.history.push('/register')}>LOGIN</Button>
          </div>
        </div>
      )
    }
